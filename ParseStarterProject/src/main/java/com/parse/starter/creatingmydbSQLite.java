...
public class creatingmydbSQLite extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_P_ID_USER = "parsesid";
    ...
    public static final String COLUMN_P_ID_MESS = "parseid";
    ...
    private static final String DATABASE_MESSAGE_CREATE =
            "create table " + TABLE_MESSAGE +
                    ...
                    + COLUMN_P_ID_MESS + " text,"
                    + COLUMN_DATE      + " text,"
                    + COLUMN_CHATROOM  + " text,"
                    + COLUMN_READE     + " Integer)";
    //event database
